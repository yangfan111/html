...
class api_result
{
	 ...
	 */
	function __construct($code, $use_error_map = true) {
		$this->error_code = $code;

		if ($use_error_map) {
			if (isset(api_error_type::$__error_map[$code]))
				$this->error_msg = api_error_type::$__error_map[$code];
			else
				$this->error_msg = null;

			if ($this->error_msg == null) {
				throw new Exception("not find error code's msg, error code:" . $code);
			}
		} else {
...
class api_error_type
{
	...
	//错误号与消息的映射
	public static $__error_map = array(
